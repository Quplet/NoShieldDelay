...
public class ModConfig {
    ...
    private static void checkConfig(CommentedFileConfig config) {
        ...
        if (!spec.isCorrect(config)) {
            ...
            config.setComment("Enabled", "This is a Fabric recreation of Revvilo's Responsive Shield's mod. Their mod mod is exclusively for Forge and I wanted a fabric one for myself, so here you go.\n" +
